...
M_Data = pd.read_csv('C:\\Users\\AP38100\\molab\\CSV\\DNAG.csv', usecols=[1,2,3,4,5,6])
G_Data = pd.read_csv('C:\\Users\\AP38100\\molab\\CSV\\PAG.csv', usecols=[1,2,3,4,5,6])
...
##### HELLO! YOU NEED TO EDIT DATA FOR LSTM